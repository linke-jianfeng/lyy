...
def Dcm2jpg(file_path):
    ...
    k=int(1)
    for files in c :
        picture_path = "C:/Users/刘耀颖/Desktop/70例NPC-20200202/13/"+files+".dcm"
        out_path ="C:/Users/刘耀颖/Desktop/70例NPC-20200202/13/"+files+".png" 
        ...
        io.imsave(out_path,dst)
        
    
    print('all is changed')
            
Dcm2jpg("C:/Users/刘耀颖/Desktop/70例NPC-20200202/13")
